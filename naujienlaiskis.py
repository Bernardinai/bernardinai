...
html_kodas += f"""
    <div class="contacts-page">
        <h1 style="border-bottom: 2px solid {THEME_COLOR}; margin-bottom: 30px; font-size: 24pt; color: #111; text-transform: uppercase;">Redakcija ir kontaktai</h1>
...
<body style="margin: 0; padding: 0; background-color: #f4f4f4;">
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background-color: #ffffff; padding: 20px;">
        ...
        <h1 style="text-align: center; color: #111; font-size: 24px;">Naujausias „Bernardinai.lt“ Kultūros savaitraštis jau paruoštas!</h1>
        ...
        with urllib.request.urlopen(req_campaign) as response:
            ...
            if campaign_id:
                payload_content = {
                    "html": email_html,
                    "plain": (
                        "Naujausias „Bernardinai.lt“ Kultūros savaitraštis jau"
